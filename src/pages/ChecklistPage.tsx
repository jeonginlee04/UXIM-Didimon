...
function calcWeekOffset(today: Date, target: Date): number {
  ...
  return Math.round(
    (getMonday(target).getTime() - getMonday(today).getTime()) / (7 * 86400000),
  );
}
...
export default function ChecklistPage() {
  ...
  // 체크 토글 핸들러 — 핵심 수정 부분
  const handleToggleStatus = (id: string, currentStatus: TodoStatus) => {
  ...
  const getPickerDays = () => {
    ...
    for (let d = 1; d <= lastDate; d++)
      cells.push(new Date(pickerYear, pickerMonth, d));
      ...
      <div className="bg-white sticky top-0 z-30">
        ...
        <div className="flex items-center px-2 pb-3">
          <button
            ...
            className="p-2 text-[#62ad9e] touch-manipulation flex-shrink-0"
          >
            <ChevronLeft size={18} />
          </button>
            ...
            {weekDates.map((date, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`w-9 h-9 rounded-2xl flex items-center justify-center text-base transition-colors ${
                      isSelected
                  ...
                  <div
                    className={`w-1.5 h-1.5 rounded-full ${
                      hasDot ? "bg-[#62ad9e]" : "bg-transparent"
                    }`}
                  />
                </button>
              );
            ...
            {filtered.map((todo, idx) => (
              <div key={todo.id}>
                <div className="flex items-center gap-3 px-5 py-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-1.5 mt-0.5">
                      ...
                      {todo.hasNotification && (
                        <Bell size={10} className="text-[#62ad9e]" />
                      )}
                    </div>
                  </div>
                  ...
                  <div className="flex gap-1 flex-shrink-0">
                    <button
                      ...
                      className="text-[10px] font-semibold text-[#62ad9e] bg-[#e0efec] rounded-lg px-2.5 py-1 touch-manipulation"
                    >
                      수정
                    </button>
                    <button
                      onClick={() => deleteTodo(todo.id)}
                      className="text-[10px] font-semibold text-[#8f9098] bg-[#f8f9fe] rounded-lg px-2.5 py-1 touch-manipulation"
                    >
                      삭제
                    </button>
                  </div>
                ...
                {idx < filtered.length - 1 && (
                  <div className="h-px bg-[#f8f9fe] mx-5" />
                )}
              </div>
            ))}
          </div>
        ...
        <div className="fixed inset-0 z-50 flex items-end">
          ...
          <div className="relative w-full max-w-[480px] mx-auto bg-white rounded-t-2xl px-5 pt-5 pb-8 animate-slide-up">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div>
                <label className="block text-xs text-[#71727a] mb-1">
                  마감일
                </label>
                <input
                  type="date"
              ...
              <div className="flex items-center justify-between py-1">
                ...
                <button
                  ...
                  className={`toggle ${addform.hasNotification ? "bg-primary" : "bg-[#c5c6cc]"}`}
                >
                  <div
                    className={`toggle-knob ${addform.hasNotification ? "translate-x-6" : "translate-x-0.5"}`}
                  />
                </button>
              </div>
              <button
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center justify-between py-1">
                ...
                <button
                  ...
                  className={`toggle ${editForm.hasNotification ? "bg-primary" : "bg-[#c5c6cc]"}`}
                >
                  <div
                    className={`toggle-knob ${editForm.hasNotification ? "translate-x-6" : "translate-x-0.5"}`}
                  />
                </button>
              </div>
              <button
          ...
          <div className="relative w-full max-w-[340px] bg-white rounded-2xl px-4 pt-4 pb-5 shadow-xl animate-slide-up">
            <div className="flex items-center justify-between mb-3">
              <button
                ...
                className="p-1.5 text-[#62ad9e] touch-manipulation"
              >
                <ChevronLeft size={18} />
              </button>
            ...
            <div className="grid grid-cols-7 gap-y-0.5">
              {getPickerDays().map((date, i) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`w-8 h-8 rounded-2xl flex items-center justify-center text-xs font-medium transition-colors ${
                        isSelected
                          ? "bg-[#62ad9e] text-white"
                          : isToday
                            ? "border border-black text-[#494a50] font-bold"
                            : dow === 5
                              ? "text-blue-500"
                              : dow === 6
                                ? "text-red-500"
